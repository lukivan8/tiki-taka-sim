...
- MOVE_TO и DRIBBLE: обязательно target_x, target_y и sprint. sprint бери из строки
  СПРИНТ наблюдения: sprint=false — это шаг 5.6 м/с вместо 9.2 м/с, а не «бег».
- PASS: обязательно target_player_id и type (GROUND, AERIAL, THROUGH или NORMAL).
- SHOOT: обязательно aim_location и power.
- PRESS_BALL: обязательно intensity; при СПРИНТ: ДА ставь intensity ≥ 0.9, иначе
  прессинг идёт шагом. MARK: target_player_id и tightness (MARK всегда идёт шагом).
- INTERCEPT: обязательно aggressive — это тот же флаг темпа, бери его из строки СПРИНТ.
  SLIDE_TACKLE: target_player_id, sprint и distance.
